...
export const projects: Project[] = [
  {
    ...
    gallery: [{ src: '/images/flux-nutrition.png' }],
  ...
  },
  {
    ...
    image: '/images/projects/flux-path/cover.png',
    video: '/videos/flux-path.mp4',
    gallery: [
      { src: '/images/projects/flux-path/cover.png', caption: 'Ziwei celestial wheel — 12-palace chart' },
      { src: '/images/projects/flux-path/hero.png', caption: 'Landing — Bazi × Ziwei engine' },
  ...
  },
  {
    ...
    gallery: [{ src: '/images/flux-career.png' }],
  ...
  },
  {
    ...
    gallery: [{ src: '/images/flux-finance.png' }],
